...
Pick an npc character type and their current state. The app will then perform the d20 randomized action lookup and relevant action table and tell you what they are doing.
